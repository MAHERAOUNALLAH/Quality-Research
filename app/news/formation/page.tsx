...
function normalizeFormation(doc: any): Formation {
  return {
    _id: String(doc._id),
    title: doc.title || "",
...
async function getFormations(): Promise<Formation[]> {
  try {
    ...
    return docs.map(normalizeFormation);
  } catch (error) {
    console.error("Failed to load formations from MongoDB:", error);
    return [];
  }
}
      ...
      <div className="relative overflow-hidden bg-white border-b border-gray-100">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20">
          ...
          <p className="mt-5 max-w-2xl text-lg text-gray-500 leading-relaxed">
            Développez vos compétences grâce à nos programmes certifiants en
            qualité et recherche en santé.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    <div className="mb-4 flex flex-wrap gap-2">
                      {formation.level && (
                        <span
                          className={`flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold ${levelStyle.bg} ${levelStyle.text}`}
                        >
                          <span>{levelStyle.badge}</span> {formation.level}
                        </span>
                      )}
        ...
        <div className="mt-20 relative overflow-hidden rounded-3xl bg-primary p-12 text-white shadow-2xl">
          ...
          <div className="relative text-center max-w-xl mx-auto">
            <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white/20 text-3xl">
              🎓
            </div>
            ...
            <p className="text-green-100 mb-7 text-lg leading-relaxed">
              Notre équipe conçoit des programmes adaptés aux besoins
              spécifiques de votre établissement de santé.
            </p>
