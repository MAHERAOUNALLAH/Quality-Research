...
async function getPartners(): Promise<Partner[]> {
  try {
    ...
    return docs.map(normalizePartner);
  } catch (error) {
    console.error("Failed to load partners from MongoDB:", error);
    return [];
  }
}
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <p className="mt-4 max-w-2xl text-gray-600">
            Quality &amp; Research s&apos;appuie sur un réseau solide de
            partenaires institutionnels, académiques et internationaux.
          </p>
      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
                  ...
                  {partner.type && (
                    <span
                      className={`rounded-full px-3 py-1 text-xs font-semibold ${
                        typeColors[partner.type] || "bg-gray-100 text-gray-600"
                      }`}
                    >
                      {partner.type}
                    </span>
        ...
        <div className="mt-14 rounded-2xl bg-primary p-10 text-center text-white shadow-lg">
          ...
          <p className="text-green-100 mb-6 max-w-xl mx-auto">
            Vous souhaitez rejoindre notre réseau et contribuer au développement
            de la qualité et de la recherche en santé ?
          </p>
